...
def foo() {
  ...
  def "old iteration naming should be restorable using configuration script"() {
    given:
...
def foo() {
  ...
  def "default iteration naming should be configurable using configuration script"() {
    given:
    runner.configurationScript {
      unroll {
