...
- Add "shared." support to ConditionalExtensions https://github.com/spockframework/spock/pull/1359[#1359]
+
ConditionalExtensions can now access shared fields via the `shared.` prefix.
...
Thanks to all the contributors to this release: Marc Philipp, Miles Thomason, BJ Hargrave, Marcin Zajączkowski, Lőrinc Pap,  Felipe Pedrosa, Marcin Świerczyński
