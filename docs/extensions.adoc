...
default is system property "spock.tempDir.keep".

.Temp Directory Configuration
[source,groovy]
----
tempdir {
  baseDir Paths.get(System.getProperty("java.io.tmpdir")) // java.nio.Path object, default null, which means system property "java.io.tmpdir"
