...
- Fix handling of condition method calls and Groovy `with()` method [#2162](https://github.com/spockframework/spock/pull/2162)
  - This could break tests using `with()` which relied on the bug in the past [#2269](https://github.com/spockframework/spock/issues/2269)
...
- Improve collection matchers by supporting them in nested in complex assertions [#1921](https://github.com/spockframework/spock/pull/1921)
