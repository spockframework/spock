...
def method() {
  ...
  def "method-level uproll annotation wins over spock.globalRollup system property"() {
    given:
...
def method() {
  ...
  @RestoreSystemProperties
  def "class-level uproll annotation wins over spock.globalRollup system property"() {
    given:
    System.properties."spock.globalRollup" = "false"
