...
class SpeckClassFileVisitor implements ClassVisitor {
  private final AnnotationVisitor annVisitor = new EmptyAnnotationVisitor();
  public boolean isSpeck = false;

  public AnnotationVisitor visitAnnotation(String desc, boolean visible) {
    if ("Lorg/spockframework/runtime/model/SpeckMetadata;".equals(desc)) isSpeck = true;
    return annVisitor;
  }
