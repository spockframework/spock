...
+
If you switch your tests that are fully green to use Spock 2.0 and get any ``MissingPropertyException``s, you are
probably hitting this change, you should then change to a derived data variable there instead of a data pipe.
+
