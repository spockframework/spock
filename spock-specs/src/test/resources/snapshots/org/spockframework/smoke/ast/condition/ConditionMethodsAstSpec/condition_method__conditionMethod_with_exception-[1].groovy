...
public void $spock_feature_0_0() {
    ...
    this.verifyAll([''], { ->
        ...
        try {
            try {
                org.spockframework.runtime.SpockRuntime.verifyCondition($spock_errorCollector1, $spock_valueRecorder1.reset(), 'true', 3, 3, null, $spock_valueRecorder1.record($spock_valueRecorder1.startRecordingValue(0), true))
            }
            catch (java.lang.Throwable $spock_condition_throwable) {
                org.spockframework.runtime.SpockRuntime.conditionFailedWithException($spock_errorCollector1, $spock_valueRecorder1, 'true', 3, 3, null, $spock_condition_throwable)}
            finally {
            }
