...
- The token `#iterationCount` in unroll patterns was deprecated and you should use the replacement token
  `#iterationIndex` instead. If you still use the old token somewhere, a warning will be printed to
  `System.err` for each occurrence.
