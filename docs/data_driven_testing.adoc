...
----
maximum of two numbers [a: 1, b: 3, c: 3, iterationIndex: 0]   PASSED
maximum of two numbers [a: 7, b: 4, c: 7, iterationIndex: 1]   FAILED
...
maximum of two numbers [a: 0, b: 0, c: 0, iterationIndex: 2]   PASSED
----
...
`my feature [x: 1, y: 2, z: 3, iterationIndex: 0]`.
