 ...
 * Cleanup of an object has the same effect as, and serves as a convenient
 * replacement for, calling the object's <tt>close</tt> method at the end
 * of the spec's <tt>cleanup</tt> method. (<tt>&#64;Shared</tt> resources are
 * cleaned up at the end of the spec's <tt>cleanupSpec</tt> method.)
 ...
 * annotation's <tt>value</tt> attribute as follows:
 *
 * <pre>
 ...
 * method) and cleanup proceeds with the next annotated object. To prevent a
 * cleanup exception from being reported, override the annotation's <tt>quiet</tt>
 * attribute:
 *
 * <pre>
