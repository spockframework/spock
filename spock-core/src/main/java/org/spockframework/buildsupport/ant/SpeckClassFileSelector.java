 ...
 */
public class SpeckClassFileSelector extends BaseExtendSelector {
  private final SpeckClassFileFinder finder = new SpeckClassFileFinder();

  @Override
  public boolean isSelected(File baseDir, String filename, File file) {
    try {
      return finder.isSpeck(file);
    } catch (IOException e) {
