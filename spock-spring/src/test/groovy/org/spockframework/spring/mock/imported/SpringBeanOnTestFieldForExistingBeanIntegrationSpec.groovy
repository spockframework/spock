...
/**
 * Test {@link SpringBean} on a test class field can be used to replace existing beans.
 *
 * original author Phillip Webb
 * @author Leonard Brünings
 * @see SpringBeanOnTestFieldForExistingBeanCacheIntegrationSpec
 */

@ContextConfiguration(classes = SpringBeanOnTestFieldForExistingBeanConfig.class)
class SpringBeanOnTestFieldForExistingBeanIntegrationSpec extends Specification {
