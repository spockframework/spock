...
class DataVariableMapTest extends Specification {
  ...
  def 'size should return proper result'() {
    expect:
    testee.size() == 2
  }

  def 'isEmpty should return proper result'() {
    expect:
  ...
  def 'containsKey should return proper result'() {
    expect:
  ...
  def 'containsValue should return proper result'() {
    expect:
  ...
  def 'get should return proper result'() {
    expect:
  ...
  def 'entrySet size should return proper result'() {
    expect:
    testee.entrySet().size() == 2
  }

  def 'entrySet isEmpty should return proper result'() {
    expect:
  ...
  def 'entrySet contains should return proper result'() {
    expect:
  ...
  def 'entrySet iterator should return proper result'() {
    expect:
  ...
  def 'entrySet toArray should return proper result'() {
    expect:
  ...
  def 'entrySet typed toArray should return proper result'() {
    expect:
  ...
  def 'entrySet containsAll should return proper result'() {
    expect:
