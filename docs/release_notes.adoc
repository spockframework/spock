...
- Add support for cross multiplying two or more data tables (https://github.com/spockframework/spock/issues/1062[#1062])
...
Thanks to all the contributors to this release: Marcin Erdmann, Björn Kautler, Alexander Kriegisch, Josh Soref
