...
public void $spock_feature_0_0() {
    ...
    try {
        ...
        try {
            ...
            org.spockframework.runtime.SpockRuntime.callBlockEntered(this.getSpecificationContext(), 5)
            org.spockframework.runtime.SpockRuntime.callBlockExited(this.getSpecificationContext(), 5)
        }
        catch (java.lang.Throwable $spock_tmp_throwable) {
            if ( $spock_feature_throwable != null) {
