...
public class SpockReleaseInfo {
  private static final VersionNumber spockVersion = VersionNumber.parse("0.4-groovy-1.7-SNAPSHOT");
  private static final VersionNumber minGroovyVersion = VersionNumber.parse("1.7.0");
  private static final VersionNumber maxGroovyVersion = VersionNumber.parse("1.7.999");
