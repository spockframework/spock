...
NOTE: This section only touches on the breaking changes, see the <<release_nodes.adoc#_release_notes, Release Notes>> for a full list of changes and new features.
