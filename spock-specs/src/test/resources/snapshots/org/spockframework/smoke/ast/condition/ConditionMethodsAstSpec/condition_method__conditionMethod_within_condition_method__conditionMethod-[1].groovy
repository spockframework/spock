        ...
        try {
            try {
                this.verifyAll([''], { ->
                    ...
                    try {
                        try {
                            org.spockframework.runtime.SpockRuntime.verifyCondition($spock_errorCollector2, $spock_valueRecorder2.reset(), 'false', 4, 5, null, $spock_valueRecorder2.record($spock_valueRecorder2.startRecordingValue(0), false))
                        }
                        catch (java.lang.Throwable $spock_condition_throwable) {
                            org.spockframework.runtime.SpockRuntime.conditionFailedWithException($spock_errorCollector2, $spock_valueRecorder2, 'false', 4, 5, null, $spock_condition_throwable)}
                        finally {
                        }
                    }
                    finally {
