...
- Fix issue that `displayName` values for the `Specification`, which were changed by extensions such as [@Title](extensions.md#title-and-narrative-extension), not being picked up. [#1509](null/pull/1509)
...
- Add junit-platform `TestTag` support with the [@Tag](extensions.md#test-tag-extension) extension [#1467](null/pull/1467)
...
- Add [collection conditions](utilities.md#collection-conditions) [#1372](null/issues/1372)
...
See [Precondition Context](extensions.md#precondition_context) for more details.
...
and add additional [Special Tokens](data_driven_testing.md#unroll_tokens) to unroll patterns.
...
The [Migration Guide 1.x - 2.0](migration_guide.md#_migration_guide_2_0) covers the major breaking changes between 1.3 and 2.0
