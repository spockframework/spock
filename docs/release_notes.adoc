...
* Multi variable datapipes now support <<data-driven-testing.adoc#multi-data-pipe-named, named deconstruction>>.
  This might lead to changed behavior results if the data object implements `Map` but supports both positional `getAt(int)` and named `getAt(String)` access. In earlier versions, the positional access was used, but now the named access will be used.
...
- Update bnd Gradle plugin to 6.0.0 (OSGI) https://github.com/spockframework/spock/pull/1377[#1377]
- Fix selector ordering issue https://github.com/spockframework/spock/pull/1375[#1375]
- Fix `@TempDir` not working for `@Shared` inherited fields https://github.com/spockframework/spock/pull/1373[#1373]
- Fix JUnit rule run order https://github.com/spockframework/spock/pull/1363[#1363]
- Prevent removal of ErrorSpecNode from execution hierarchy https://github.com/spockframework/spock/pull/1358[#1358]
+
...
- Fix double invocation of IRunListener.beforeSpec and IRunListener.afterSpec https://github.com/spockframework/spock/pull/1344[#1344]
- Fix regression with multi-assignment of method call result https://github.com/spockframework/spock/pull/1333[#1333]
- Fix Build MethodSource with the correct spec class name https://github.com/spockframework/spock/pull/1345[#1345]
+
...
- Fix NPE if variable is initialized using a method with the same in features with cleanup blocks or using thrown condition https://github.com/spockframework/spock/issues/1266[#1266] https://github.com/spockframework/spock/issues/1313[#1313]
- Fix implicit this conversion after bugfix in Groovy 3.0.8 https://github.com/spockframework/spock/issues/1318[#1318]
- Fix extension-provided method arguments in fixture methods https://github.com/spockframework/spock/issues/1305[#1305]
...
- Add new `displayName` via `INameable` for `SpecInfo`, `FeatureInfo`, and `IterationInfo`.
  ...
  https://github.com/spockframework/spock/issues/1236[#1236]
...
- Improve final field handling.
  ...
  unmodifiable to user code. https://github.com/spockframework/spock/issues/1011[#1011]

- Improve parallel extensions to support inheritance https://github.com/spockframework/spock/issues/1245[#1245]
...
- Fix https://github.com/spockframework/spock/issues/1294[#1294] swallowing of unrecoverable Errors

- Fix https://github.com/spockframework/spock/issues/1260[#1260] Change InteractionRewriter to keep casting of ListExpressions intact

- Fix https://github.com/spockframework/spock/issues/1282[#1282] Make TempDirInterceptor safe for parallel invocation of iterations

- Fix https://github.com/spockframework/spock/issues/1267[#1267] Retry extension behavior for unrolled tests

- Fix https://github.com/spockframework/spock/issues/1267[#1267] Retry extension behavior for unrolled tests

- Fix https://github.com/spockframework/spock/issues/1229[#1229] `@TempDir` not working for inherited fields

- Fix https://github.com/spockframework/spock/issues/1232[#1232] compile error for nested conditions without top-level condition
...
- Fix https://github.com/spockframework/spock/issues/1263[#1263] ExceptionAdapterExtension to also handle inherited fixture methods

- Fix https://github.com/spockframework/spock/issues/1279[#1279] Cast data variables with type coercion to the declared parameter type
...
- Type casts in conditions are now properly carried over to properly disambiguate method calls.
  For more information see issue https://github.com/spockframework/spock/issues/1022[#1022].
