...
public class RunStatus {
  ...
  public static final int END_SPECK = END | SPECK;
  ...
  public static final int ABORT_SPECK = ABORT | SPECK;
  ...
  public static int scope(int status) {
    return status & (ITERATION | FEATURE | SPECK | ALL);
  }

  /**
   * Combines status1 and status2 by individually maximizing action and scope.
   * Example: combine(END_SPECK, ABORT_FEATURE) == ABORT_SPECK
   */
