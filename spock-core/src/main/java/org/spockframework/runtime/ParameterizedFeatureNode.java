  ...
  class ChildExecutor implements DynamicTestExecutor {
    ...
    public void execute(TestDescriptor testDescriptor) {
      ...
      if (featureInfo.isReportIterations()) {
        ...
        execute(delegate, testDescriptor, new EngineExecutionListener() {
          @Override
    ...
    private void execute(DynamicTestExecutor delegate, TestDescriptor testDescriptor, EngineExecutionListener listener) {
      try {
