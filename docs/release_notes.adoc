...
https://code.google.com/p/hamcrest/[Hamcrest] assertions read better in then-blocks:
...
Method arguments can now be constrained with https://code.google.com/p/hamcrest/[Hamcrest] matchers:
